...
print *, "linearized solution, part I"
do m = 1, 3
! vel = m*0.1
...
if (mark == 1) open(unit = 22, file = 'phi1_I.bin', access='stream', status='unknown')
if (mark> 1) open(unit = 22, file = 'phi1_I.bin', access='stream', status='old', position = 'append')
